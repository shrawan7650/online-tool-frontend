...
export function URLEncodePage() {
  ...
  return (
    <div className="max-w-4xl px-4 py-8 mx-auto sm:px-6 lg:px-8 animate-fade-in">
        <SEOHead
        title="URL Encode/Decode Tool - Safe URL Encoding Online"
        description="Free online URL encoder and decoder tool. Safely encode URLs for transmission or decode encoded URLs back to readable text. Supports Unicode and special characters."
        keywords="URL encode, URL decode, percent encoding, URI encoding, web development tools, online encoder"
        canonicalUrl="/url-encode"
      />
      <div className="mb-8 text-center">
        ...
        <p className="text-lg text-slate-400">
          Safely encode URLs for transmission or decode encoded URLs back to
          readable text
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 mb-8 lg:grid-cols-2">
        ...
        {/* Result Section */}
        <div className="tool-card">
          <h3 className="mb-4 text-lg font-semibold text-white">Result</h3>
          {result ? (
      ...
      <div className="mt-8 tool-card">
        ...
        <div className="prose prose-invert max-w-none">
          <p className="text-slate-400">
            URL encoding (also called percent-encoding) is used to encode
            special characters in URLs to ensure they are transmitted safely
            over the internet. Characters like spaces, ampersands, and question
            marks have special meanings in URLs and must be encoded.
          </p>
